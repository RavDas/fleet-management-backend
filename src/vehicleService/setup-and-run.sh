...
echo -e "${WHITE}   🌐 API:              http://localhost:8479${NC}"
echo -e "${WHITE}   📚 Swagger Docs:     http://localhost:8479 (root URL)${NC}"
echo -e "${WHITE}   💚 Health Check:     http://localhost:8479/health${NC}"
echo -e "${WHITE}   🚗 Vehicles API:     http://localhost:8479/api/vehicles${NC}"
echo ""
